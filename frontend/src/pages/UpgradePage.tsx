...
export default function UpgradePage() {
  ...
  const currentPlan = {
    ...
    price: userProfile?.plan_type === 'pro' ? '$29' : '$0',
    journeys: { 
      used: userProfile?.journey_count || 0, 
      total: userProfile?.plan_type === 'pro' ? 25 : 5 
    },
    features: userProfile?.plan_type === 'pro' 
      ? [
  ...
  const plans = [
    ...
    },
    {
      ...
      popular: true,
      current: currentPlan.name === 'Pro' || currentPlan.name === 'pro'
    },
    {
      name: 'Enterprise',
      price: 'Custom',
