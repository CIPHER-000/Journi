...
export function TemplateModal({ open, onOpenChange, template, onUseTemplate }: TemplateModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-3 pt-4 border-t">
            <Button onClick={() => onUseTemplate(template)} className="flex-1">Use This Template</Button>
