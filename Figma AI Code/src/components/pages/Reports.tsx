...
import { Download, Edit, Calendar, Users, TrendingDown, TrendingUp, AlertTriangle, Lightbulb, ArrowRight, FileText, MessageSquare, Target } from "lucide-react";

interface ReportsProps {
  journeyId?: string;
}

export function Reports({ journeyId }: ReportsProps) {
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">{journeyData.insights.summary}</p>
            </div>
          </div>
        </CardContent>
      </Card>
